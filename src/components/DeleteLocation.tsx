...
export default function DeleteLocation({ id, closeModal }: any) {
  const handleDeleteLocation = () => {
    console.log(id);
    axiosInstance.delete(`/api/location/${id}`).then((res) => {
      console.log(res);
      closeModal();
    });
  };
      ...
      <div className="bg-white w-1/2 p-6 rounded-lg">
        <div className="flex justify-between">
          <h2 className="text-lg font-bold mb-4">
            Er du sikker på du vil slette lokationen med id: {id}?
          </h2>
